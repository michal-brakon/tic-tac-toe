...
String result = "None";
String someOneWin = "wins";
        for (int i = 0; i < 3; i++) {
            if (
                    ((grid[0][0] == grid[0][1]) && (grid[0][1] == grid[0][2]) && (grid[0][2] == 'x')) ||
                    ...
                    ((grid[0][2] == grid[1][1]) && (grid[1][1] == grid[2][0]) && (grid[2][0] == 'x'))
            ) {
                result = "X Wins";
            break; }
             if (
                    ((grid[0][1] == grid[0][1]) && (grid[0][1] == grid[0][2]) && (grid[0][2] == 'o')) ||
                    ...
                    ((grid[0][2] == grid[1][1]) && (grid[1][1] == grid[2][0]) && (grid[0][2] == 'o'))
            ) {
                result = "o Wins";
            break; }
            if (freeSpots == 0)
